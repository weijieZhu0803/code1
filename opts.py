...
def parse_opts():
    ...
    parser.add_argument(
        '--root_path',
        default='/mnt/Dual_resnet_pytorch_unbantu/S_C_C2_4_new/',
        #default='G:\ZWJ\Dual_resnet_pytorch',
        type=str,
    ...
    parser.add_argument(
        '--weight_decay', default=1e-7, type=float, help='Weight Decay')
    parser.add_argument(
        '--mean_dataset',
        default='',
        type=str,
    ...
    parser.add_argument(
        ...
        default=101,
        type=int,
        help='Depth of resnext (10 | 18 | 34 | 50 | 101)')
    parser.add_argument(
        '--resnet_shortcut',
        default='B',
        type=str,
